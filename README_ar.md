...
- **2026-09-09** 🛢️ **عقد نفط خام أمريكي تمّت تسويته باليوان، وقالب استراتيجية اخترع عائداً بنسبة 0% من سعر مفقود**: الرمز `CL2412.NYMEX` لم يطابق أي نمط — الصيغة المؤرَّخة المجرّدة (`CL2412`) تطابق، وصيغة البورصة (`ES.CME`) تطابق، أما الطريقة التي يُكتب بها العقد فعلياً فلا تطابق أياً منهما — فسقط إلى القيمة الافتراضية لسوق الأسهم الصينية وجرى تنفيذه بقاعدة T+1 دون بيع على المكشوف وبتسوية باليوان. وعلى الجانب الصيني كانت تهجئات البورصات في Tushare تمثّل الوجه المقابل للمشكلة نفسها ([#1396](https://github.com/HKUDS/Vibe-Trading/pull/1396)، يغلق [#1394](https://github.com/HKUDS/Vibe-Trading/issues/1394))؛ والنصفان يُصنَّفان الآن بشكل صحيح. وبشكل منفصل، لا تزال pandas تملأ القيم للأمام افتراضياً في `pct_change()`، فيتحوّل الإغلاق المفقود إلى **عائد مقداره 0.0% لم يحدث قط**، وتُبلغ الشمعة التالية عن حركة يومين على أنها حركة يوم واحد. أصلح طلبا دمج موضعاً واحداً لكلٍّ منهما ([#1397](https://github.com/HKUDS/Vibe-Trading/pull/1397)، [#1398](https://github.com/HKUDS/Vibe-Trading/pull/1398))؛ ومسحٌ شامل للمهارات وجد **24 موضعاً في 10 ملفات**، اثنان منها داخل الملفات نفسها التي كان هذان الطلبان يعدّلانها، وحارس على مستوى المستودع يُبقي هذا الصنف مغلقاً. كما تُصرّح اختبارات العقود الآجلة الصينية الآن بالمنتجات التي جرى تسعيرها بقيمة افتراضية عامة بدلاً من مدخل في الجدول — فنسبة الهامش الحقيقية لـ `rb` هي 0.10، وهي الرقم نفسه الذي تحمله القيمة الافتراضية، و«ما جرى استخراجه» يجب ألّا يُقرأ كأنه «ما جرى افتراضه» (يغلق [#1393](https://github.com/HKUDS/Vibe-Trading/issues/1393)). ودُمج أيضاً: إزالة تسريب التسميات المستقبلية في مثال التدريب المتدحرج للتعلم الآلي ([#1392](https://github.com/HKUDS/Vibe-Trading/pull/1392))، واستبعاد الأصول التي لا تملك أي رصد لعوامل من اختيار TopN ([#1399](https://github.com/HKUDS/Vibe-Trading/pull/1399))، وتعامد عامل المشاعر الذي لم يعد ينحدر على الأصفار التي ملأها بنفسه ([#1400](https://github.com/HKUDS/Vibe-Trading/pull/1400)).
